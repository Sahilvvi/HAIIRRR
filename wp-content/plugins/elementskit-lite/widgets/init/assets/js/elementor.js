!(function (e, t) {
  ...
  let n = {
    ...
    Whatsapp: function (t) {
      ...
      function a() {
        let t = e(i).val(),
          n = e(".elementskit-whatsapp__input--btn")
            .attr("href")
            .replace(/text=/g, `text=${t}`);
        e(".elementskit-whatsapp__input--btn").attr("href", n);
      }
      "show" == e(".elementskit-whatsapp__content").data("show") &&
        e(".elementskit-whatsapp__content").addClass(
          "elementskit-whatsapp__active"
        ),
        e(n).click(function () {
          e(".elementskit-whatsapp__content").toggleClass(
            "elementskit-whatsapp__active"
          );
        }),
        ...
        e(i).keypress(function (t) {
          13 == t.which &&
            (a(),
            (window.location = e(".elementskit-whatsapp__input--btn").attr(
              "href"
            )));
        });
    },
